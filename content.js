...
const STAGES = [
  ...
  },
  {
    ...
    type: 'ttt',
    requires: 6, // открывается после 6 пройденных этапов
    questions: [],
  },
  {
    key: 'output',
  ...
  },
  {
    ...
    title: 'Нейро-Слоп',
    icon: '🧠',
    tagline: 'Финальный босс — угадай что нарисовала нейросеть',
    type: 'neural',
    requires: 7,
    questions: [
      { id: 'n1', prompt: 'Что здесь нарисовала нейросеть?', hint: 'Присмотрись к форме — это кто-то из другого мира', options: ['Пришелец', 'Робот-пылесос', 'Кот', 'Пицца'], correct: 0 },
    ],
  },
];
